...
class Nyx(Character):
    ...
    def __init__(self) -> None:
        super().__init__(
            name="nyx",
            description=(
                "An ethereal being of impossible beauty, with skin like moonlight and hair that "
                "shimmers with the colors of autumn leaves. Her eyes hold the wisdom of millennia, "
                "and when she moves, flowers bloom in her footsteps. She radiates an aura of ancient "
                "magic and natural power."
            ),
        )
