        ...
        if not game_state.get_story_flag(FLAG_HEALERS_APPRENTICE_ACCEPTED):
            if has_crystal_focus:
                return ("[success][character_name]Master Healer Lyria[/character_name] recognizes your magical potential "
                        "and notices the [item_name]Crystal Focus[/item_name] you carry. 'That crystal focus! It's exactly "
                        "what I need to help my patients who are on the brink of death. If you're willing to give it to me, "
                        "I can use it to save lives and teach you advanced healing magic in return.' Her eyes show both "
                ...
                return ("[character_name]Master Healer Lyria[/character_name]: Welcome to my house of healing. I can "
                        "sense magical potential in you, but I desperately need help. I have patients on the brink of death "
                        "who need more powerful healing than I can provide alone. If you could bring me a "
                        "[item_name]Crystal Focus[/item_name] to amplify my magic, or some [item_name]Healing Herbs[/item_name] "
                        "to show your commitment to healing, I will teach you advanced techniques.")
    ...
    def give_item(self, game_state: GameState, item_object) -> str:
        ...
        if isinstance(item_object, CrystalFocus):            
            ...
            return ("[success][character_name]Master Healer Lyria[/character_name] accepts the "
                    ...
                    "With this crystal focus, I can amplify my healing magic to treat patients on the brink of death.' "
                    "She immediately begins using it to help her critically injured patients. 'Through your compassion "
            ...
            return ("[success][character_name]Master Healer Lyria[/character_name] accepts the "
                    ...
                    "spell! 'Use this knowledge wisely, young healer. You've successfully completed your apprenticeship.'[/success]")
        else:
