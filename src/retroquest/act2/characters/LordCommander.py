...
class LordCommander(Character):
    ...
    def __init__(self) -> None:
        super().__init__(
            name="lord commander",
            description="A distinguished military officer wearing elaborate ceremonial armor adorned with Greendale's coat of arms. "
                        "His bearing speaks of years of command and the authority to make important decisions affecting the realm's knights."
        )

    def talk(self, game_state: 'GameState') -> str:
        if game_state.get_story_flag(FLAG_CEDRIKS_HONOR_COMPLETED):
            return ("The Lord Commander nods with satisfaction. \"Sir Cedric's honor has been fully restored. "
                    "The false accusations against him have been officially stricken from the record. "
                    "It brings me great pleasure to see justice served and a good knight vindicated.\"")
        
        if game_state.get_story_flag(FLAG_EXAMINED_SECRET_DOCUMENTS):
            # Player has the secret documents and should present them
            return ("The Lord Commander looks at you with interest. \"I understand you have evidence regarding "
                    "Sir Cedric's case? If you have the secret documents that prove his innocence, "
                    "please present them to me so I can officially restore his honor.\"")
        
        return ("The Lord Commander greets you formally. \"Welcome to Greendale's Great Hall. "
