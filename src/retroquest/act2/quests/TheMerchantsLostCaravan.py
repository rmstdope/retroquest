...
class TheMerchantsLostCaravanQuest(Quest):
    def __init__(self) -> None:
        super().__init__(
            ...
            completion="You successfully located the missing caravan trapped in a deep ravine within the Enchanted Forest. Using forest speech magic to communicate with woodland creatures, you discovered their location, then employed quality rope to rappel down and rescue the trapped merchants. All merchants survived the ordeal, and Caravan Master Thorne rewarded you with secret documents containing evidence that can clear Sir Cedric's name of false accusations from a past court case.",
        )
