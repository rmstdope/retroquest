...
class ForestHeartCrystal(Item):
    """A powerful crystal containing the very essence of the forest's heart."""
    
    def __init__(self) -> None:
        super().__init__(
            name="forest heart crystal",
            description="A magnificent crystal that seems to contain an entire living forest within its translucent "
