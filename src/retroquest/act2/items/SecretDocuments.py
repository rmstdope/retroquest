...
class SecretDocuments(Item):
    ...
    def examine(self, game_state: 'GameState') -> str:
        if not game_state.get_story_flag(FLAG_READ_SQUIRES_DIARY):
            return ("You examine the sealed documents carefully. They appear to be official legal papers and "
                    "testimonies from some kind of court case or military tribunal, but without more context "
                    "about what you're looking for, you can't make sense of their significance. The names and "
                    "details mentioned don't mean anything to you at the moment.")
