...
class StandingStones(Item):
    def __init__(self) -> None:
        super().__init__(
            ...
            short_name="stones",
            description=(
                "Ancient stone monoliths covered in moss and carved with protective runes that pulse with "
                "faint magic. These druidic markers have stood for centuries, representing protection, "
                "passage, and the balance between civilization and wilderness. The old magic within them "
                "protects travelers at this threshold."
            ),
    ...
    def examine(self, game_state: GameState) -> str:
        ...
        if not self.examined:
            ...
            if not game_state.has_spell(NatureSenseSpell().name):
                ...
                spell_msg = (
                    "\n\n[success]As you trace the druidic runes with your finger, ancient knowledge flows into "
                    "your mind. The symbols begin to make sense—they're not just markers, but a teaching tool! "
                    "You feel a connection forming with the natural world around you, and suddenly you "
                    "understand how to cast the [spell_name]Nature's Sense[/spell_name] spell![/success]\n\n"
            ...
            return (
                ...
                "protection, passage, and the balance between civilization and wilderness. These stones "
                "have stood here for centuries, marking the boundary between worlds. You can feel the "
                "old magic thrumming within them, a gentle but powerful force that has protected travelers "
                "for generations.[/info]"
                + spell_msg
            )
        else:
