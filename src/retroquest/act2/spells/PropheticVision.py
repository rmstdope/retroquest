    ...
    def cast_spell(self, game_state: GameState) -> str:
        ...
        if not game_state.get_story_flag(FLAG_GATHERING_STORM_COMPLETED):
            ...
            return (
                ...
                "like fragments of a shattered mirror, each reflecting a possible future:\n\n"

                "You see shadows gathering in the north, darker than any natural darkness. Ancient evils "
                "stir in forgotten places, and you sense that Malakar's interest in Willowbrook was only "
                "the beginning of a much larger design. The scattered threads of fate show you glimpses "
                "of trials yet to come - allies who will stand with you, enemies who will test your resolve, "
                "and choices that will shape the very fabric of the world.\n\n"

                "The vision fades, but the knowledge remains. Sir Cedric's expression grows grave as he "
                "witnesses the prophetic revelations. You understand now that your journey has only just "
                "begun, and the gathering storm spoken of by Sir Cedric is far greater than anyone imagined. "
                "Together, armed with this foresight, you are better prepared for whatever challenges lie "
                "ahead.[/magic]"
            )
        else:
            return (
                "[magic]You cast the prophetic vision spell, and brief glimpses of possible futures dance "
                "before your eyes. The gift of foresight reminds you that every choice creates ripples "
