...
Narrative Role:
Powerful heirloom artifact intentionally withheld early to establish narrative guardianship and foreshadow magical systems and responsibility themes.

Key Mechanics / Interactions:
- Always blocks pickup via `prevent_pickup` dialogue from Mira, signaling preparation prerequisites (not yet mechanically enforced beyond message).
...
Design Notes:
- Future: replace unconditional block with conditional check (e.g., all preparation flags set) then allow carry.
