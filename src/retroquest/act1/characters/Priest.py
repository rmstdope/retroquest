...
class Priest(Character):
    ...
    def talk_to(self, game_state: GameState) -> str:
        ...
        return event_msg + "\n" + f"The [character.name]{self.get_name()}[/character.name] offers a serene smile. [dialogue]'Welcome, child. The chapel is a sanctuary for all who seek peace. The shadows in our land grow long, but faith can be a guiding light.'[/dialogue]"
